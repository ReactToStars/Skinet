...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51Klw1IH9lPk2VTtdJV8dJO8CWDhdHhaQl5HdPH71ES8R14q6cHV1bPrzDnkAKUbJy8ecS1mM8bqM8RZSWKs68d5N00LLf9Y1A6').then(stripe => {
      this.stripe = stripe;
  ...
  async submitOrder() {
    ...
    try {
      ...
      if (paymentResult.paymentIntent) {
        ...
        this.toatr.error(paymentResult.error.message);
      }
    } catch (error: any) {
      console.log(error);
  ...
  private async createOrder(basket: Basket | null) {
    ...
    return firstValueFrom(this.checkoutService.createOrder(orderToCreat));
  }

  getOrderToCreate(basket: Basket): OrderToCreat {
